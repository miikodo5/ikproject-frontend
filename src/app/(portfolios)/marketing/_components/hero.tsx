    ...
    return (
        <>
            <div className={'w-full h-[632px]'}>
                ...
                <Wrapper>
                    <div className={'h-[330px] mt-[110px] w-full flex flex-col justify-center max-laptop:h-[243px] max-phone:flex-col max-phone:h-[191px] max-phone:mt-[128px] backdrop-blur-[4px]'}>
                        <span className={'self-start text-h80 max-laptop:text-h1 max-phone:text-1xl'}>{header.split(' ')[0]}</span>
                        <span className={'self-center -my-[72px] text-h198 font-stick max-laptop:text-4xl max-laptop:-my-[18px] max-phone:text-4xl '}>{header.split(' ')[1]}</span>
                        <span className={'self-end text-h80 max-laptop:text-h1 max-phone:text-1xl '}>{header.split(' ')[2]}</span>
                    </div>
